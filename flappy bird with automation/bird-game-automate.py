...
while run:
    ...
    # get height of top column and place the bird in between poles
    #print(top_pole_height)
    # at first let the poles come a bit closer
    if pole_x < 250:
        # if birds y point is less than top column height or more than the gap
        if (bird_y < top_pole_height) or (bird_y > (top_pole_height + GAP - 50)):
            # place the bird in this position
            bird_y = top_pole_height + 40
    """ ******************************************************************************* """
